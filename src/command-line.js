 ...
 * @property {boolean} listen If Wulf's Hollow is listening on all network interfaces
 ...
 * @property {boolean} browserLaunchEnabled If automatically launch Wulf's Hollow in the browser
    ...
    parse(args) {
        const cliArguments = yargs(hideBin(args))
            ...
            .option('browserLaunchEnabled', {
                type: 'boolean',
                default: null,
                describe: 'Automatically launch Wulf\'s Hollow in the browser',
            })
